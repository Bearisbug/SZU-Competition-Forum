...
export default function TagCloud() {
  ...
  return (
    <div className="flex flex-row items-start relative">
      <div className="absolute right-20 bottom-20 w-80 h-80 p-8 bg-black bg-opacity-50 backdrop-blur-sm 
                     rounded-lg border border-gray-700 flex flex-col justify-center
                     transform transition-all duration-300 hover:scale-105">
        <h2 className="text-white text-xl font-semibold mb-3">你好</h2>
        <p className="text-white text-opacity-80">这是卡片的内容</p>
      </div>

      <div className="tagcloud-wrapper flex-1 max-w-6xl">
        <div
